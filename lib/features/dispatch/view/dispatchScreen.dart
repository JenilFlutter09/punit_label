                            ...
                            : CustomButton(
                               ...
                               *//* onPressed: () {
                                  ...
                                  ExportHelper.exportReport(
                                    context: context,
                                    titlePdf:
                                        'Dispatch  ${controller.selectedProduct.value}',
                                    titleExcel:
                                        'Dispatch  ${controller.selectedProduct.value}',
                                    metaData: {
                                      /// "Customer Name": controller.inwardUsefulData.value?.customer_name ?? "Customer",
                                    ...
                                    data: controller.barcodeList.map((e) {
                                      return [
                                        (controller.barcodeList.indexOf(e) + 1)
                                            .toString(),
              ...
              children: [
                ...
                if ((product.variation ?? []).isNotEmpty)
                  Wrap(
                    spacing: 8,
                    runSpacing: 6,
                    children: product.variation!.map(_buildVariationChip).toList(),
                  ),
