...
class BatchInwardController extends GetxController {
  ...
  void generatePdf(){
    ...
    ExportHelper.generatePDF(title: title, metaData: {
  ...
  Future<void> addToList() async  {
    ...
    Map<String, String> labelFields = isTareWeightOff.value ? {...combinationFields, ...manualNFields} : {...combinationFields, ...manualGTNFields};
