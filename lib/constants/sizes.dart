...
abstract class Dimens {
  ...
  static double fourHundredSeventyFive = 475.sp;
  ...
  // static var edgeInsets12_10_16_10;
  ...
  static EdgeInsets edgeInsets15_0 = EdgeInsets.symmetric(
    horizontal: fifteen,
    vertical: zero,
  );
  ...
  static EdgeInsets edgeInsets5_5_5_5 = EdgeInsets.all(five);
  static EdgeInsets edgeInsets5_0_5_10 =  EdgeInsets.only(
    top: zero,
    left: five,
    right: five,
    bottom: twenty,
  );
  static EdgeInsets edgeInsets5_5_5_0 = EdgeInsets.only(
    top: five,
    left: five,
    right: five,
    bottom: zero,
  ...
  static EdgeInsets edgeInsets20_40_0_30 = EdgeInsets.fromLTRB(
    twenty,
    fourty,
    zero,
    thirty,
  );
  static EdgeInsets edgeInsets10_25_10_0 = EdgeInsets.fromLTRB(
    ten,
    twentyFive,
    ten,
    zero,
  ...
  static EdgeInsets edgeInsets10_8_10_10 = EdgeInsets.fromLTRB(
    ten,
    eight,
    ten,
    ten,
  ...
  static EdgeInsets edgeInsets5_0_115_0 = EdgeInsets.fromLTRB(
    five,
    zero,
    hundredFifteen,
    zero,
  ...
  static EdgeInsets edgeInsets0_15_10_10 = EdgeInsets.fromLTRB(
    zero,
    fifteen,
    ten,
    ten,
  ...
  static EdgeInsets edgeInsets5_15_5_15 = EdgeInsets.fromLTRB(
    five,
    fifteen,
    five,
    fifteen,
  ...
  static EdgeInsets edgeInsets0_40_0_0 = EdgeInsets.fromLTRB(
    zero,
    fourty,
    zero,
    zero,
  ...
  static EdgeInsets edgeInsets0_15 = EdgeInsets.symmetric(
    horizontal: zero,
    vertical: fifteen,
  );
  ...
  static EdgeInsets edgeInsets5_0_15_0 = EdgeInsets.fromLTRB(
    five,
    zero,
    fifteen,
    zero,
  ...
  static EdgeInsets edgeInsets16_45_16_20 = EdgeInsets.fromLTRB(
    sixteen,
    fourtyFive,
    sixteen,
    twenty,
  ...
  static EdgeInsets edgeInsets50_40_0_0 = EdgeInsets.fromLTRB(
    fifty,
    fourty,
    zero,
    zero,
  );
  static EdgeInsets edgeInsets25_0_25_0 = EdgeInsets.fromLTRB(
    twentyFive,
    zero,
    twentyFive,
    zero,
  ...
  static EdgeInsets edgeInsets5_30_5_5 = EdgeInsets.fromLTRB(
    five,
    thirty,
    five,
    five,
  ...
  static EdgeInsets edgeInsets15_2_0_2 = EdgeInsets.fromLTRB(
    fifteen,
    two,
    zero,
    two,
  ...
  static EdgeInsets edgeInsets00_08_00_00 = EdgeInsets.fromLTRB(
    zero,
    eight,
    zero,
    zero,
  ...
  static EdgeInsets edgeInsets3_0_3_0 = EdgeInsets.fromLTRB(
    three,
    zero,
    three,
    zero,
